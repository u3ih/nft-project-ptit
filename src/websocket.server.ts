...
import {
    getSocketIoMetadata, SOCKET_IO_CONNECT_METADATA, SOCKET_IO_METADATA, SOCKET_IO_SUBSCRIBE_METADATA,
    SocketIoBindings,
    SocketIoControllerFactory,
    SocketIoMetadata,
    SocketIoTags,
...
export class SocketIoServer extends Context {
    ...
    async start(httpServer?: HttpServer) {
        ...
        this.io.attach(this.httpServer.server, {
            cors: {
                origin: "*",
                methods: "*",
            },
